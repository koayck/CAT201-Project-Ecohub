...
import static com.ecohub.AddViewController.list_Field;
...
public class HomepageController implements Initializable {
    ...
    private void loodScreens() {
        try {
            root_DefaultScreen = FXMLLoader.load(getClass().getResource("DefaultScreen.fxml"));
            root_AddView = FXMLLoader.load(getClass().getResource("AddView.fxml"));
            root_ShowView = FXMLLoader.load(getClass().getResource("ShowView.fxml"));
            //===========
            Image info = new Image(getClass().getResourceAsStream("/resources/infoPNG.png"));
            //===========
            root_EditField = FXMLLoader.load(getClass().getResource("EditField.fxml"));
            ...
            //===========
            root_EditBook = FXMLLoader.load(getClass().getResource("EditBook.fxml"));
            ...
            //===========
            root_AlertConfirm = FXMLLoader.load(getClass().getResource("AlertConfirm.fxml"));
            ...
            //===========
            root_AlertInfo = FXMLLoader.load(getClass().getResource("AlertInfo.fxml"));
